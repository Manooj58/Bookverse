...
const Home = () => {
  ...
  return(
    ...
    <div className="w-full minmd:w-4/5">
      <Banner banner="Your new asset to digital world." childStyles="md:text-4xl sm:text-2xl xs:text-xl text-left" parentStyles="justify-start mb-6 h-72 sm:h-60 p-12 xs:p-4 xs:h-44 rounded-3xl" />
      <div>
